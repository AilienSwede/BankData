...
select
  ...
  sum(sod.BRANCH_DEPOSIT_AMOUNT) as BRANCH_DEPOSITS_AMOUNT,
  case when min(INSTITUTION_DEPOSITS_AMOUNT) = sum(sod.BRANCH_DEPOSIT_AMOUNT)
    then min(INSTITUTION_DEPOSITS_AMOUNT)
    else max(INSTITUTION_DEPOSITS_AMOUNT)
  end as INSTITUTION_DEPOSITS_AMOUNT,
  sum(sod.BRANCH_DEPOSIT_AMOUNT) -   case when min(INSTITUTION_DEPOSITS_AMOUNT) = sum(sod.BRANCH_DEPOSIT_AMOUNT)
    then min(INSTITUTION_DEPOSITS_AMOUNT)
    else max(INSTITUTION_DEPOSITS_AMOUNT)
  end AS NON_BRANCH_DEPOSITS_AMOUNT,
