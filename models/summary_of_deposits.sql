...
select
        ...
        TRY_CAST(CLCODE AS INT)                     AS INSTITUTION_CATEGORY_CODE,
        TRIM(CNTRYNA)                               AS INSTITUTION_COUNTRY_NAME,
        TRY_CAST(DENOVO AS INT)                     AS INSTITUTION_ORIGINAL_CHARTER_FLAG,
        TRY_CAST(DEPDOM AS INT) * 1000              AS INSTITUTION_DOMESTIC_DEPOSITS_AMOUNT,
        ...
        TRIM(INSAGNT1)                              AS INSTITUTION_PRIMARY_INSURER_CODE,
        TRIM(INSURED)                               AS INSTITUTION_INSURANCE_TYPE_CODE,
        TRY_CAST(INSBRDD AS INT) * 1000             AS INSTITUTION_INSURED_DEPOSITS_US_TERRITORIES_AMOUNT,
        TRY_CAST(INSBRTS AS INT) * 1000             AS INSTITUTION_INSURED_CDS_US_TERRITORIES_AMOUNT,
        TRY_CAST(OCCDIST AS INT)                    AS INSTITUTION_OCC_DISTRICT_CODE,
        TRIM(OCCNAME)                               AS INSTITUTION_OCC_DISTRICT_NAME,
        TRIM(REGAGNT)                               AS INSTITUTION_PRIMARY_REGULATOR_CODE,
